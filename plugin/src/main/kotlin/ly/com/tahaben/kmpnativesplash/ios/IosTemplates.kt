...
internal fun brandingImageViewXml(
    brandingImageName: String,
    mode: ly.com.tahaben.kmpnativesplash.dsl.BrandingMode
): String {
    val rect = when (mode) {
        ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM -> """<rect key="frame" x="146.5" y="700" width="100" height="100"/>"""
        ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM_LEFT -> """<rect key="frame" x="16" y="700" width="100" height="100"/>"""
        ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM_RIGHT -> """<rect key="frame" x="277" y="700" width="100" height="100"/>"""
    }
...
internal fun brandingConstraintsXml(mode: ly.com.tahaben.kmpnativesplash.dsl.BrandingMode, bottomPadding: Int): String {
    val padding = bottomPadding.coerceAtLeast(0)
    val (horizontalAttr1, horizontalAttr2, horizontalId) = when (mode) {
        ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM -> Triple("centerX", "centerX", "KSP-bcx-001")
        ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM_LEFT -> Triple("leading", "leading", "KSP-blg-001")
        ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM_RIGHT -> Triple("trailing", "trailing", "KSP-btr-001")
    }
    val constant = if (mode == ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM_RIGHT) "-16" else "16"
    val horizontalConstant =
        if (mode == ly.com.tahaben.kmpnativesplash.dsl.BrandingMode.BOTTOM) "" else """ constant="$constant""""
